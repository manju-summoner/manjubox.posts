...
### コピペイラーズ
以下のような形式の台本をもとに、プロジェクトファイル（.ymmp）を作成するツールです。
```
キャラクターA『セリフ１』
キャラクターB『セリフ２』
```
配布元：[コピペイラーズ](https://programer-d.github.io/ConvertScenarioIntoYmmp/)  
開発者：[Programer-D](https://twitter.com/Programer_D) 様  

### コピペイラーズ（カスタムボイス版）
外部ツールで出力したwavファイルをもとに、プロジェクトファイル（.ymmp）を作成するツールです。

配布元：[コピペイラーズ（カスタムボイス版）](https://programer-d.github.io/ConvertScenarioIntoYmmp/voiceroid.html)  
開発者：[Programer-D](https://twitter.com/Programer_D) 様  

### 【RPA】ExcelVBAでゆっくりムービーメーカー4を自動化【ゆっくり解説】
Excelで作成した台本をもとに、タイムラインにボイスアイテムを配置するExcelマクロです。

配布元：[【RPA】ExcelVBAでゆっくりムービーメーカー4を自動化【ゆっくり解説】](http://tamajimu.sytes.net/archives/935)  
