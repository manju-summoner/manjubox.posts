...
YMM3の後継となる、ゆっくりMovieMaker4ベータ版（開発版）の配布ページです。  
動画出力機能、倍速プレビュー、テンプレート機能等、多くの新機能を実装している他、以前のバージョンと比べてプレビューの正確性・安定性が向上しています。
...
- 本アプリを使用することによって何らかの損害が発生した場合でも、作者は一切の責任を負わないものとします。自己責任で使用してください。
...
## ダウンロード
本ソフトを使用して実況動画を作成し、ニコニコ動画で動画を公開する場合、動画の親作品に[sm20953272](http://www.nicovideo.jp/watch/sm20953272)の登録をお願いします。 [>>登録方法](/ymm3/tutorial/output/h20134199232488/)
...
## 外部ソフトウェア
YMM4で利用可能な外部ソフトの一覧です。（[掲載依頼はこちら](/お問い合わせ/)）

### コピペイラーズ
以下のような形式で作成された台本を元に、プロジェクトファイル（.ymmp）を作成するソフトです。
```
キャラクターA『セリフ１』
キャラクターB『セリフ２』
```
配布元：[コピペイラーズ](https://programer-d.github.io/ConvertScenarioIntoYmmp/)  
製作者：[Programer-D](https://twitter.com/Programer_D)様  
