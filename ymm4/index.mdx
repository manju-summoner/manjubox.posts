...
date: 2020-08-30
tags: [YMM4]
description: ゆっくり実況プレイ動画用動画編集ソフト「ゆっくりMovieMaker4」の配布ページです
---
...
### YMM4TemplateEditor
![スクリーンショット](index_4343.png)
[あおもや](https://x.com/bluemist_im)さんによって開発されている、テンプレートの管理ツールです。
- [YMM4TemplateEditor](https://github.com/bluemistel/YMM4TemplateEditor)

### YMM4 9:16 エフェクトエディタ
[うのっち](https://x.com/unoksanpt)さんによって開発されている、9:16の縦長動画用のエフェクトテンプレートを作成するツールです。
- [YMM4 9:16 エフェクトエディタ](https://github.com/sanpeita/ymm4-vertical-effect-editor)
...
### 書き庭（KAKINIWA）
![スクリーンショット](index_4956.png)
[黒猫ゲーム部](https://x.com/ryuuou_neko)さんによって開発されている台本生成ツールです。  
YMM4用の台本を出力できるほか、専用プラグインを使用することで、台本の内容をそのままタイムラインに反映させることが可能です。  
- [書き庭（KAKINIWA）](https://kakiniwa.jp/)
...
https://booth.pm/ja/items/4374126
