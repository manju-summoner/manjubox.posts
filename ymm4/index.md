...
### V-Adapter
![スクリーンショット](index_1740.png)
[あおもや](https://x.com/bluemist_im)産によって開発されている、各種音声合成ソフトの再生と保存を共通ショートカットで実行できる簡易マクロツールです。
- [V-Adapter](https://github.com/bluemistel/V-Adapter)
- [ダウンロードページ](https://github.com/bluemistel/V-Adapter/releases)
...
<!--
脆弱性が含まれているCMSで運営されており、ダウンロードリンクが改竄可能な状態で放置されているため、一時的に掲載を停止

Ghost 5.54 / CVE-2026-26980
https://jvndb.jvn.jp/ja/contents/2026/JVNDB-2026-004477.html

過去にこの脆弱性を元にスクリプト注入攻撃を受けた経歴あり
掲載停止時点で動作しなくなってはいるが、スクリプトURLが注入されている状態で放置されている
https://x.com/rainbow7akane/status/2069034792604328432

同一脆弱性・同一攻撃パターンによる被害の一例
https://x.com/yousukezan/status/2058574218607144969

脆弱性対応状況の確認方法
ページ内のメタデータ<meta name="generator" content="Ghost 5.54">がGhost 6.19.1に以降に更新されていることを確認する
...
### manimとvoicevoxを使用したプロジェクト作成ツール
[ゆっくり亭](https://x.com/Tamaji1234)さんによって開発されている、manimとvoicevoxを使用したプロジェクト作成ツールです。
- [pythonでmanimとvoicevoxを操って、ずんだもんの平面幾何解説動画を作ってみた](http://oreoreki.gotdns.ch/?p=2627)
...
### YMM4 ゆっくり素材一括リネーム
![スクリーンショット](index_4014.png)
[Ｇスカ](https://x.com/GSka01)さんによって開発されている、YMM3でサポートしていた「キャラ素材」をYMM4用の「動く立ち絵素材」に一括で変換するツールです。
- [【YMM4】YMM3用ゆっくり素材をボタン一つでYMM4用に一括リネーム！素材変換ツールの配布](https://gska.hatenablog.jp/entry/2026/05/22/020728)

### YMM4AutoDirector
![スクリーンショット](index_1409.png)
[ぽん太](https://x.com/ponta_banto)さんによって開発されている、セリフから推定した感情を元に、プロジェクトファイルの表情を自動的に変更したり、画像を挿入するツールです。
- [YMM4AutoDirector](https://ponapp.booth.pm/items/8284251)

### YMM4 EmotionMaker KIT
![スクリーンショット](index_3504.png)
[あおもや](https://x.com/bluemist_im)さんによって開発されている、プロジェクトのセリフを感情分析し、動く立ち絵の表情を自動配置できるツールです。
- [YMM4 EmotionMaker KIT](https://github.com/bluemistel/YMM4EmotionMekerKIT)
- [ダウンロードページ](https://github.com/bluemistel/YMM4EmotionMekerKIT/releases)

### YMM4 Plugin Catalog
![スクリーンショット](index_5259.png)
[もづりぃ](https://x.com/modurili)さんによって運営されている、GitHubで公開されているYMM4プラグインの一覧サイトです。
- [YMM4 Plugin Catalog](https://modurili.github.io/YMM4Plugin/)

### YMM4 情報サイト
![スクリーンショット](index_3617.png)
[いるかぁぁ](https://x.com/Dolphin__kun)さんによって運営されている、ユーザー投稿型のYMM4関連情報サイトです。
- [YMM4 情報サイト](https://ymm4-info.net/)

### YMM4プロジェクトクリーナー
![スクリーンショット](index_3634.png)
[Gスカ](https://x.com/GSka01)さんによって開発されている、最近のプロジェクト一覧から任意のプロジェクトを削除することができるツールです。
- [YMM4プロジェクトクリーナー](https://gska.hatenablog.jp/entry/YMM4PC)

### YMM4台本メーカー
![スクリーンショット](index_0828.png)
[💄Yuzuko💋](https://x.com/yuzuko212)さんによって運営されている、YMM4用の台本を作成するWebツールです。
- [YMM4台本メーカー](https://ymm-4csv-creater.vercel.app/)
...
### うごめき
![スクリーンショット](index_0301.png)
[あおもや](https://x.com/bluemist_im)さんによって開発されている、PSDファイルをYMM4の「動く立ち絵」形式にあわせて出力する加工ソフトです。
- [bluemistel / PSD-to-YMM4CharacterSprite](https://github.com/bluemistel/PSD-to-YMM4CharacterSprite)

### ゆっくりムービーメーカー4Hubソフト
![スクリーンショット](index_4725.png)
...
### 漢字に自動でルビを振るだけのサイト
![スクリーンショット](index_5133.png)
[Jin](https://x.com/jin1194315)さんによって開発されている、漢字交じりの文章に自動的にYMM4用のルビタグを付与するWebツールです。
- [漢字に自動でルビを振るだけのサイト](https://kanji-rubifuri.bucket3123947.workers.dev/)
