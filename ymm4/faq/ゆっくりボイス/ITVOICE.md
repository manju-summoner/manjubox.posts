...
[ITVOICE](https://booth.pm/ja/items/4374126)は[いたほび](https://twitter.com/iTahobi)さんが個人で開発されているフリーの音声合成ソフトです。  
VOICEVOX互換の外部連携APIを使用し、YMM4から直接音声を生成できます。  
※細かい利用規約は[ITVOICE公式サイト](https://booth.pm/ja/items/4374126)をご確認ください。
- [ITVOICE](https://booth.pm/ja/items/4374126)

## 利用方法
1. [ITVOICE](https://booth.pm/ja/items/4374126)をインストールする
